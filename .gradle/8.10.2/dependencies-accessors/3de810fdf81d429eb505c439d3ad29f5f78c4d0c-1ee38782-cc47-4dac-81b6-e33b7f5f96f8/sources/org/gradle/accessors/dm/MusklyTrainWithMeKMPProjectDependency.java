...
@NonNullApi
public class MusklyTrainWithMeKMPProjectDependency extends DelegatingProjectDependency {

    @Inject
    public MusklyTrainWithMeKMPProjectDependency(TypeSafeProjectDependencyFactory factory, ProjectDependencyInternal delegate) {
