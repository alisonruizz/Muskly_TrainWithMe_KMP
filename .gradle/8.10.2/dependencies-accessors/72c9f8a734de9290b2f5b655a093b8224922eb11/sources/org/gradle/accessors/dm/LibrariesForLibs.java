...
public class LibrariesForLibs extends AbstractExternalDependencyFactory {
    ...
    public static class AndroidxRuntimeLibraryAccessors extends SubDependencyFactory {
        private final AndroidxRuntimeSaveableLibraryAccessors laccForAndroidxRuntimeSaveableLibraryAccessors = new AndroidxRuntimeSaveableLibraryAccessors(owner);
        ...
        /**
         * Group of libraries at <b>androidx.runtime.saveable</b>
         */
        public AndroidxRuntimeSaveableLibraryAccessors getSaveable() {
            return laccForAndroidxRuntimeSaveableLibraryAccessors;
        }

    }

    public static class AndroidxRuntimeSaveableLibraryAccessors extends SubDependencyFactory {

        public AndroidxRuntimeSaveableLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }

        /**
         * Dependency provider for <b>android</b> with <b>androidx.compose.runtime:runtime-saveable-android</b> coordinates and
         * with version reference <b>runtimeSaveableAndroid</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         */
        public Provider<MinimalExternalModuleDependency> getAndroid() {
            return create("androidx.runtime.saveable.android");
        }
    ...
    public static class VersionAccessors extends VersionFactory  {
        ...
        /**
         * Version alias <b>runtimeAndroid</b> with value <b>1.5.4</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
        ...
        /**
         * Version alias <b>runtimeSaveableAndroid</b> with value <b>1.9.5</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getRuntimeSaveableAndroid() { return getVersion("runtimeSaveableAndroid"); }
